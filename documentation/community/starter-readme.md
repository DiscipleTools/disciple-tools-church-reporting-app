[![Build Status](https://travis-ci.com/DiscipleTools/disciple-tools-reporting-app.svg?branch=master)](https://travis-ci.com/DiscipleTools/disciple-tools-reporting-app)
