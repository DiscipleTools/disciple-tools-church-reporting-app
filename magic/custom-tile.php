    ...
    public function dt_custom_fields_settings( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" ) {
            ...
            $fields["leader_milestones"] = [
                'name' => __( 'Leader Milestones', 'disciple-tools-reporting-app' ),
                'description' => __( "This is a leader/practitioner working towards movement.", 'disciple-tools-reporting-app' ),
                'type' => 'multi_select',
                'default' => [
                    'trained' => [
                        'label' => __( 'Trained', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Trained in disciple multiplication.', 'field description', 'disciple-tools-reporting-app' ),
                        "icon" => get_template_directory_uri() . '/dt-assets/images/coach.svg?v=2'
                    ],
                    'practicing' => [
                        'label' => __( 'Practicing', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Actively practicing disciple multiplication.', 'field description', 'disciple-tools-reporting-app' ),
                        "icon" => get_template_directory_uri() . '/dt-assets/images/group-peer.svg?v=2'
                    ],
                    'baptizing' => [
                        'label' => __( 'Baptizing', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Actively practicing disciple multiplication.', 'field description', 'disciple-tools-reporting-app' ),
                        "icon" => get_template_directory_uri() . '/dt-assets/images/group-peer.svg?v=2'
                    ],
                    'planting_churches' => [
                        'label' => __( 'Planting Churches', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Has started a simple church and is working to start others.', 'field description', 'disciple-tools-reporting-app' ),
                        "icon" => get_template_directory_uri() . '/dt-assets/images/stream.svg?v=2'
                    ],
                    'coaching_leaders' => [
                        'label' => __( 'Coaching Leaders', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Has experience and can coach other practicing leaders.', 'field description', 'disciple-tools-reporting-app' ),
            ...
            $fields["leader_community_restrictions"] = [
                'name' => __( 'Community Restrictions', 'disciple-tools-reporting-app' ),
                'description' => __( "Restrictions for communication and publicity of information in the community/coalition/network.", 'disciple-tools-reporting-app' ),
                'type' => 'multi_select',
                'default' => [
                    'no_inquiries' => [
                        'label' => __( 'No Inquiries', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Do not connect me with other community members or forward inquiries to me.', 'field description', 'disciple-tools-reporting-app' ),
                        "icon" => get_template_directory_uri() . '/dt-assets/images/alert-circle-exc.svg?v=2'
                    ],
                    'no_public_map' => [
                        'label' => __( 'No Public Map', 'disciple-tools-reporting-app' ),
                        'description' => _x( 'Do not add my location to the public map. Internal maps can have my location.', 'field description', 'disciple-tools-reporting-app' ),
                        "icon" => get_template_directory_uri() . '/dt-assets/images/alert-circle-exc.svg?v=2'
                    ]
                ],
                "tile" => "details",
        ...
        if ( $post_type === $this->post_type ){
            ...
            if ( isset( $fields["leader_milestones"] ) ) {
                if ( current_user_can( 'dt_all_admin_' . $this->post_type ) ){
                    ...
                    $filters["tabs"][] = [
                        "key" => "all",
                        "label" => __( "Leadership Milestones", 'disciple-tools-reporting-app' ),
                        "order" => 20
                    ];
                    ...
                    $filters["tabs"][] = [
                        "key" => "assigned_to_me",
                        "label" => __( "My Leader Milestones", 'disciple-tools-reporting-app' ),
                        "order" => 20
                    ];
                    foreach ( $fields["leader_milestones"]["default"] as $status_key => $status_value ) {
                        if ( isset( $status_counts[$status_key] ) ){
