...
class DT_Reporting_App_Heatmap {
    ...
    public static function clear_practitioner_grid_totals() {
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totals' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsa0' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsa1' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsa2' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsa3' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsa4' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsworld' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_practitioner_grid_totalsfull' );
    }
...
//        }
    ...
    public static function clear_church_grid_totals() {
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totals' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsa0' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsa1' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsa2' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsa3' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsa4' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsworld' );
        delete_transient( 'DT_Reporting_App_Heatmap:query_church_grid_totalsfull' );
    }
