...
class DT_Reporting_App_Metrics_Map_Practitioners extends DT_Metrics_Chart_Base
{
    ...
    public function __construct() {
        $this->magic_link = site_url() . '/reporting_app/heatmap_practitioner/';
        parent::__construct();
...
DT_Reporting_App_Metrics_Map_Practitioners::instance();
