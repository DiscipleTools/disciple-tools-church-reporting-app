...
class DT_Metrics_Reporting_App_Maps_Churches extends DT_Metrics_Chart_Base
{
    ...
    public $title = 'Church Saturation';
    public $slug = 'church-saturation-map';
    ...
    public $namespace = 'dt-metrics/reporting_app_church';
    public $base_filter = [];
    ...
    public function __construct() {
        ...
        $this->title = __('Church Saturation', 'disciple_tools' );
        ...
        wp_localize_script(
            'dt_mapbox_script', 'dt_mapbox_metrics', [
                'settings' => [
                    ...
                    'split_by' => [ "group_status" => $field_settings["group_status"], "group_type" => $field_settings["group_type"] ],
                ],
            ]
        );
    }
...
new DT_Metrics_Reporting_App_Maps_Churches();
