...
class DT_Metrics_Reporting_App_Maps extends DT_Metrics_Chart_Base
{
    ...
    public $namespace = 'dt-metrics/reporting_app_practitioner';
    public $base_filter = [];
        ...
        wp_localize_script(
            'dt_mapbox_script', 'dt_mapbox_metrics', [
                'settings' => [
                    ...
                    'split_by' => [ "leader_milestones" => $field_settings["leader_milestones"] ],
                ],
            ]
        );
    }
...
new DT_Metrics_Reporting_App_Maps();
